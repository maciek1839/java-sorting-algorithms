...
public class AlgorithmDataProvider {
    public static Stream<Arguments> getDataToSort() throws BenchmarkDataNotFoundException, IOException {
        return Stream.of(
                ...
                Arguments.of(
                        StaticValueProvider.getBenchmarkDataGenerator().loadData(AlgorithmsBenchmarkData.FIFTY_THOUSANDS),
                        StaticValueProvider.getBenchmarkDataGenerator().loadData(TestBenchmarkData.SORTED_50K_BENCHMARK_DATA)
                )
        );
    }
}
